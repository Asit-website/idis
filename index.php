...
<body>
 <?php include 'partials/_dbconnect.php';?>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="https://source.unsplash.com/2400x700/?laptop,programmer" class="d-block w-100" alt="...">
    </div>
  </div>
 ...
 <!-- cards start here  -->
  <div class="container my-4" id="ques">
    <h2 class="text-center my-4">categories-- idiscuss browse categories</h2>
    <div class="row">
...
<!-- jisko jisko jaha bhejo vaha ? threadid='.$id.' -->